...
def fb_process():
    ...
    # PERBAIKAN KRUSIAL: Menggunakan JavaScript untuk redirect paksa
    # Ini akan memaksa webview untuk memproses skema URL kustom
    return f"<html><head><script>window.location.href=\"{target_url}\";</script></head><body></body></html>"
